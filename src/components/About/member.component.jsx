...
export const Member = ({ last,name,role,profile_url,email,linked_url}) => {
  return (
   <div className={`w-full flex flex-col items-center text-center p-2 ${last && "sm:col-span-1 col-span-2"}`}>
     <img src={profile_url}alt="member" className="w-28 h-28 border border-info object-contain rounded-full my-2" />
      ...
      <a href={`mailto://${email}`} target="_blank">
        ...
        <a href={linked_url} target="_blank">
        <Linkedin {...IconProps}  />
        </a> 
